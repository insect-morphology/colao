 ...
 * [colao.yml](colao.yml)
     * Determines how your purl.obolibrary.org/obo/colao/ redirects will be handled
     ...
     * Paste in the contents of [colao.yml](colao.yml)
 ...
 * [colao.md](colao.md)
     ...
     * Paste in the contents of [colao.md](colao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
