These notes are for the EDITORS of colao
...
Make sure you have an ID range in the [idranges file](colao-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [colao-edit.owl](colao-edit.owl)

** DO NOT EDIT colao.obo OR colao.owl in the top level directory **
 ...
 * [colao-idranges.owl](colao-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/colao_terms.txt file
...
Note: the colao_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as colao.owl and colao.obo and places
...
what is in the `owl:versionIRI` of the derived colao.owl (`data-version` in
colao.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/colao.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/colao/releases/YYYY-MM-DD.owl <-- change to the release you just made
